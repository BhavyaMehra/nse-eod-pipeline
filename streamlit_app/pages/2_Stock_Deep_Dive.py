...
fig = go.Figure()
fig.add_trace(go.Scatter(x=price_df['trade_date'], y=price_df['close'].round(2), name='Close', line=dict(color='white', width=1.5)))
fig.add_trace(go.Scatter(x=price_df['trade_date'], y=price_df['ma_20d'].round(2), name='20d MA', line=dict(color='cyan', width=1)))
fig.add_trace(go.Scatter(x=price_df['trade_date'], y=price_df['ma_50d'].round(2), name='50d MA', line=dict(color='orange', width=1)))
...
fig3 = go.Figure()
fig3.add_trace(go.Scatter(x=price_df['trade_date'], y=price_df['vol_20d'], name='Volatility', line=dict(color='yellow', width=1.5)))
